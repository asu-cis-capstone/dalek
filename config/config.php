 ...
 */
define("DB_HOST", "198.71.225.50");
define("DB_NAME", "projectdalek");
define("DB_USER", "secure_user");
define("DB_PASS", "Ek~6od47");
...
define("COOKIE_DOMAIN", "198.71.225.50");
define("COOKIE_SECRET_KEY", "jkfjc8*219@P!");
...
define("EMAIL_SMTP_HOST", "ssl://smtp.gmail.com");
define("EMAIL_SMTP_AUTH", true);
define("EMAIL_SMTP_USERNAME", "projectdalekrr@gmail.com");
define("EMAIL_SMTP_PASSWORD", "ProjectDalek123!");
define("EMAIL_SMTP_PORT", 465);
define("EMAIL_SMTP_ENCRYPTION", "ssl");
 ...
 */
define("EMAIL_PASSWORDRESET_URL", "http://localhost/project-dalek-test/password_reset.php");
define("EMAIL_PASSWORDRESET_FROM", "no-reply@example.com");
define("EMAIL_PASSWORDRESET_FROM_NAME", "Project Dalek");
define("EMAIL_PASSWORDRESET_SUBJECT", "Password reset for Project Dalek");
 ...
 */
define("EMAIL_VERIFICATION_URL", "http://localhost/project-dalek-test/register.php");
define("EMAIL_VERIFICATION_FROM", "no-reply@example.com");
define("EMAIL_VERIFICATION_FROM_NAME", "Project Dalek");
define("EMAIL_VERIFICATION_SUBJECT", "Account activation for Project Dalek");
